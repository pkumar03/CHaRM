...
class StoriesTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        itemInfoText
            .bold("1. ")
            .normal("Input your zip code into the field.")
            .bold("\n2. ")
            .normal("Select all recyleable materials that you have brought in. If prompted, please input the quanitity of the material that you brought.")
            .bold("\n3. ")
            .normal("When finished, swipe down to the bottom of the page and press the 'Submit' button.")
